...
import com.cy.threadbus.exception.ThreadBusException;
...
public final class ObjectHelper {
    ...
    public static <T> T requireNonNull(T object, String message) {
        if (object == null) {
            throw new ThreadBusException(message);
        }
        return object;
    }
    ...
    public static List requireListNonNullOrEmpty(List list, String message) {
    ...
    public static <T> T getExistObject(T object, T defaultObject) {
